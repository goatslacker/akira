...
(function () {
  var escodegen, dune, lexer, implicitReturn, _$m, parser, me, prelude, HEADER, OPTIONS, COMPACT, makeProgram, transform, genProgramAst, transpile, replify, run;
  ...
  transform = function (name, parsed) {
    ...
    return function () {
      ...
      default:
        ...
        return {
          core: parsed.addCore(),
          body: makeProgram(parsed.addVars(context).concat(dependencies, parsed.addContracts(body)), context)
        };
      }
  ...
  genProgramAst = function (name, code) {
    ...
    }(transform(name, parser.parse(lexer(code))));
  };
  transpile = function (name, code) {
    return function (x) {
      var _$m, core, body, top, bottom;
      _$m = x;
      core = _$m.core;
      body = _$m.body;
      top = escodegen.generate({
        type: 'Program',
        body: core
      }, COMPACT);
