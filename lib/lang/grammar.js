(function () {
    ...
    bnf = {
        ...
        Modules: [o('MODULE STR Body', function () {
                return new Modules($2, $3);
            })],
        Exporting: [
            o('EXPORT Expression', function () {
                return new Export($2, false);
            }),
            o('EXPORT * Expression', function () {
                return new Export($3, true);
            })
        ],
        Cloning: [
            o('Identifier : Arguments', function () {
                return new Cloning($3, $1);
            }),
        ...
        Declaration: [
            ...
            o('LAMBDA TBody', function () {
                return new Declaration(null, null, $2);
            })
        ],
        InlineDeclaration: [
        ...
        SugaryFunctions: [
            ...
            o('Accessor Arguments', function () {
                return new Declaration('->', new Arguments('it'), new Call(new Access('it', $1), $2));
            }),
