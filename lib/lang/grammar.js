(function () {
    ...
    bnf = {
        ...
        Async: [
            o('TASK [ ] TBody', function () {
                return yy.L(yylineno, new yy.Async(null, $4));
            }),
            o('TASK [ Parameters ] TBody', function () {
                return yy.L(yylineno, new yy.Async($3, $5));
            })
        ],
        Awaitable: [o('AWAIT CallableValue', function () {
                return yy.L(yylineno, new yy.Await($2));
            })],
        AsyncDo: [
            o('DO Value Declaration', function () {
                return yy.L(yylineno, new yy.Do($2, $3));
            }),
            o('DO Value InlineDeclaration', function () {
                return yy.L(yylineno, new yy.Do($2, $3));
            })
        ],
        ...
        If: [
            o('Value IF CallableValue', function () {
                return yy.L(yylineno, new yy.If($3, $1, null));
            }),
            o('IF CallableValue OptTerminator THEN Body OptTerminator ELSE Body', function () {
