module.exports = (function () {
    ...
    bnf = {
        ...
        Assignable: [
            ...
            o('` OptTerminator Expression', function () {
        ...
        Exporting: [o('EXPORT Assignable', function () {
                return new Export($2);
            })],
        Cloning: [
        ...
        CondElse: [o('ELSE ? Body TERMINATOR', function () {
                return [
                    $1,
                    $3
                ];
        ...
        Pattern: [o('Value ? Body TERMINATOR', function () {
                return [
                    $1,
                    $3
                ];
        ...
        Default: [o('ELSE ? Body TERMINATOR', function () {
                return new Arguments([
                    $1,
                    $3
                ]);
            })],
        PatternMatching: [o('FN [ Parameters ] TERMINATOR Patterns Default', function () {
        ...
        Macro: [o('Identifier Arguments', function () {
