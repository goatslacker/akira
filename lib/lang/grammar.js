(function () {
    ...
    bnf = {
        ...
        Modules: [o('MODULE STR Body', function () {
                return yy.L(yylineno, new yy.Modules($2, $3));
            })],
        Exporting: [
            o('EXPORT Expression', function () {
                return yy.L(yylineno, new yy.Export($2, false));
            }),
            o('EXPORT * Expression', function () {
                return yy.L(yylineno, new yy.Export($3, true));
            })
        ],
        Cloning: [
        ...
        MaybeSeq: [
            o('MAYBE [ MaybeParameters ] TBody', function () {
                return yy.L(yylineno, new yy.MaybeSeq($5, $3));
            }),
            o('MAYBE TBody', function () {
                return yy.L(yylineno, new yy.MaybeSeq($2));
            })
        ],
        DoOperation: [
            o('Vectors DO_OPERATOR Value TERMINATOR', function () {
                return {
                    args: $1,
                    call: $3
                };
        ...
        AsyncDo: [
            ...
            o('DO Terminator DoOperations', function () {
                return yy.L(yylineno, new yy.Async($3, null));
            })
        ],
        ...
        Class: [o('CLASS Identifier TypeValues', function () {
                return yy.L(yylineno, new yy.Class(yy.L(yylineno, new yy.TypeSignature($2, '', $3))));
            })],
        Maps: [
            o('{ }', function () {
