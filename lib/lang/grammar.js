...
(function () {
  ...
  bnf = {
    ...
    AsyncDo: [
      o('DO Value AllCallables', function () {
        return yy.L(yylineno, new yy.Do($2, $3, null));
      }),
      o('DO Value AllCallables DO CATCH AllCallables', function () {
        return yy.L(yylineno, new yy.Do($2, $3, $6));
      })
    ],
