...
(function () {
  ...
  bnf = {
    ...
    Invocation: [o('Accessibles Arguments', function () {
    ...
    AsyncDo: [o('DO ValuePlusCalls OptTerminator THEN AllCallables Terminator CATCH AllCallables', function () {
    ...
    Class: [
      ...
      o('CLASS OptInherits OptImplements Indent Constructor Terminator ClassMembers Dedent', function () {
        return yy.L(yylineno, new yy.Class($5, $7, $3, $2));
      })
    ],
