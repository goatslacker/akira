...
(function () {
  ...
  bnf = {
    ...
    AsyncFunction: [
      o('ASYNC [ ] TBody', function () {
        return yy.L(yylineno, new yy.AsyncFunction(null, $4));
      }),
      o('ASYNC [ Parameters ] TBody', function () {
    ...
    Class: [
      o('CLASS OptImplements { Terminator Constructor Terminator }', function () {
        return yy.L(yylineno, new yy.Class($5, [], $2));
      }),
      o('CLASS OptImplements { Terminator Constructor Terminator ClassMembers Terminator }', function () {
        return yy.L(yylineno, new yy.Class($5, $7, $2));
      })
    ],
