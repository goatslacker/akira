...
!function() {
var copy=function(x,y){var keys;keys=Object.keys(y);keys.forEach(function(k){return x[k]=y[k];});return x;};var zipWith=function(f,_$fpds1,_$fpds2){var a,as,b,bs;a=_$fpds1[0];as=_$fpds1.slice(1,_$fpds1.length-0);b=_$fpds2[0];bs=_$fpds2.slice(1,_$fpds2.length-0);return typeof a==='undefined'||typeof b==='undefined'?[]:[f(a,b)].concat(zipWith(f,as,bs));};function map(f,a){if(arguments.length==1)return function(a){return map(f,a);};var i=0,l=a.length,r=Array(l);for(i;i<l;i+=1)r[i]=f(a[i]);return r;}
