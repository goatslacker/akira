...
//      }
    ...
    var nodes = traverse(tree, function (node, parent) {
      if (hasTypeCheck(node)) {
        ...
        var fnBody = CallExpression(
          MemberExpression(
            FunctionExpression(null, [], fn.body.body),
            Identifier('apply'),
            false
          ),
        ...
        return AssignmentExpression(
          ...
          FunctionExpression(
            null,
            fn.params,
            typeCheckArgs(Store.types[name].params, fn.params).concat(
              typeCheckReturn(Store.types[name].retval, fnBody))
          )
        )
      }
