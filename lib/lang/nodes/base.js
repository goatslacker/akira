...
Base.CallExpression = require('../js-ast/CallExpression');
Base.FunctionExpression = require('../js-ast/FunctionExpression');
...
Base.functioncall = a(function (callee, args) {
  ...
  args = args.map(function(arg, idx) {
    var ref = { type: 'Identifier', name: '_$ref' + idx }

    if (arg.type === 'IfStatement') {
      add.push({
        type: 'VariableDeclaration',
        kind: 'var',
        declarations: [Base.assignment({}, ref, null)]
      });
      add.push(arg);
      assignLastStmt(ref, [arg], {});
