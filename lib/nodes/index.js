(function () {
var path, r, Access, Arguments, Assignment, Call, Compare, Comprehension, Construction, Declaration, Exception, Export, If, Identifier, Import, Literal, List, Nodes, Operation, Pattern, Pipeline, Tuple;
path = require('path');
r = function (m) {
...
this.Comprehension = Comprehension = r('comprehension');
