(function () {
    ...
    _$37e60b = function () {
        ...
        watch = function (filename, callback) {
            return nodewatch.add(filename).onChange(callback);
        };
        return watch;
    }();
    util = require('util');
    ...
    loadMakefile = function (key, opts) {
        return function (name, code) {
            ...
            make = run(name, 'module.exports = '.concat(code))[cmd];
            return make(opts);
        };
    };
    cli = function (_$p0, _$p1) {
        ...
        case !(_$p0 === 'repl' && _$p1.length === 0 && arguments.length === 2):
            return startRepl();
        case !(_$p0 === 'help' && _$p1.length === 0 && arguments.length === 2):
            return help();
        default:
