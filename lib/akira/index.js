module.exports = (function ($$export) {
    var util, me, akira, run, lex, genAst, benchmark, writeFile, getFiles, startRepl, watch, exports, output, analyse, MEM;
    var map;
    map = function (f, vec) {
    ...
    return MEM = function (action, $$vec1) {
        var $$offset1 = 0, filename = $$vec1[$$offset1++], x = $$vec1[$$offset1++];
        switch (false) {
        case !(action === 'compile'):
            return akira(function (name, code) {
                return exports(name, code, filename, x);
            }, filename);
        case !(action === 'output'):
