module.exports = (function ($$export) {
    var util, me, akira, run, lex, genAst, benchmark, writeFile, getFiles, startRepl, watch, exports, output, analyse, loadMakefile, MEM;
    var map;
    map = function (f, vec) {
    ...
    var $$73272e = function ($$export) {
            ...
            run = function (name, code, customContext) {
                var context, result;
                if (customContext == null)
                    customContext = {};
                context = Object.create(Object(customContext), {
                    console: {
                        value: console
                    }
                });
