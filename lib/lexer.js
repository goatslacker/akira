...
var Lexer = (function () {
  ...
  var KEYWORDS = ["assert", "fn", "print", "return", "while"];
  ...
  $.tokenize = function (code) {
    ...
    while (i < code.length) {
      ...
      } else if (rx.invocation.test(chunk)) {
        tokens.push(["FNCALL", ":", line_no]);
        i += 1;
      ...
      // operations
        ...
        item = rx.comments.exec(chunk)[1];

        tokens.push(["COMMENT", item, line_no]);
