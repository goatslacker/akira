...
code = parser.generate().concat('parser.lexer = { lex: function () { var tag, _ref2; _ref2 = this.tokens[this.pos++] || [""]; tag = _ref2[0]; this.yytext = _ref2[1]; this.yylineno = _ref2[2] || 0; return tag; }, setInput: function (tokens) { this.tokens = tokens; return this.pos = 0; } }');
