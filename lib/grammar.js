module.exports = (function ($$export) {
    ...
    bnf = {
        ...
        SugaryFunctions: [
            ...
            o('Accessor', function () {
                return new Declaration(null, new Arguments('it'), new Access('it', $1));
            }),
            o('Accessor : Value', function () {
                return new Declaration(null, new Arguments('it'), new Call(new Access('it', $1), $3));
            }),
            o('COMPARE Value', function () {
                return new Declaration(null, new Arguments('it'), new Compare('it', $1, $2));
            }),
            o('LEFT_OPERATORS Value', function () {
                return new Declaration(null, new Arguments('it'), new Operation('it', $1, $2));
            }),
            o('+ Value', function () {
                return new Declaration(null, new Arguments('it'), new Operation('it', $1, $2));
            }),
