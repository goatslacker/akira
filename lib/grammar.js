module.exports = (function ($$export) {
    ...
    bnf = {
        ...
        MathOperators: [
            ...
            o('COMPARE', function () {
                return new Call(new Identifier('_compare'), new Arguments(new Literal(String($1))));
            }),
            o('LEFT_OPERATORS', function () {
                return new Call(new Identifier('_operatel'), new Arguments(new Literal(String($1))));
            })
        ],
        SpecialFunctions: [
