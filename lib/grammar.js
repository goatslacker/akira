(function() {
  ...
  parser = new Parser((function() {
    ...
    bnf = {
      ...
      Expression: [o('Literal'), o('Assignment'), o('Invocation'), o('Pipeline'), o('Declaration'), o('Operation')],
      ...
      Pipeline: [
        o('Invocation | PRINT', function() {
          return new Call($3, $1);
        }), o('Invocation | Identifier', function() {
          return new Call($3, $1);
        }), o('$ Arguments | Identifier', function() {
          return new Call($4, $2);
        }), o('$ Arguments | PRINT', function() {
          return new Call($4, $2);
        }), o('Pipeline | Identifier', function() {
          return new Call($3, $1);
        }), o('Pipeline | PRINT', function() {
          return new Call($3, $1);
        })
      ],
      Invocation: [
    ...
    operators = [['right', '=', '|', '(', ')', 'PRINT'], ['nonassoc', '{', '}', 'LAMBDA'], ['left', 'LOGIC'], ['left', 'COMPARE'], ['left', '+', '-'], ['left', '*', '/']];
    return {
      tokens: tokens,
      bnf: bnf,
      operators: operators,
