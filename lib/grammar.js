(function() {
  ...
  parser = new Parser((function() {
    ...
    bnf = {
      ...
      Expression: [o('Import'), o('Value'), o('If'), o('Assignment'), o('Assert'), o('Invocation'), o('Pipeline'), o('Declaration')],
      ...
      Declaration: [
        o('Identifier ( Parameters ) LAMBDA Body', function() {
          ...
          return new Call(new Declaration(null, $3, $6), null);
        })
      ],
      Lists: [
      ...
      If: [
        o('IF Value ( Body ) ( Body )', function() {
          return new If($2, $4, $7);
        })
      ],
      Assert: [
        o('ASSERT Value COMPARE Value', function() {
          return new Assert($2, $3, $4);
        }), o('ASSERT Value LOGIC Value', function() {
          return new Assert($2, $3, $4);
        })
      ],
      Operation: [
