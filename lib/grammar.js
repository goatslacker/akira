module.exports = (function ($$export) {
    ...
    bnf = {
        ...
        SpecialFunctions: [
            ...
            o('( Accessor )', function () {
                return new Declaration(null, new Arguments('it'), new Access('it', $2));
            }),
            o('( COMPARE Value )', function () {
                return new Declaration(null, new Arguments('it'), new Compare('it', $2, $3));
            }),
            o('( LEFT_OPERATORS Value )', function () {
                return new Declaration(null, new Arguments('it'), new Operation('it', $2, $3));
            }),
            o('( MathOperators Value )', function () {
                return new Declaration(null, new Arguments('it'), new Call($2, new Arguments('it', $3)));
            })
        ],
        Operation: [
