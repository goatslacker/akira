...
bnf = {
    ...
    ArrowPipeline: [
        o('Value PIPE ArrowPipe', function () {
            return new Pipeline($1, $3);
        }),
        o('Invocation PIPE ArrowPipe', function () {
            return new Pipeline($1, $3);
        }),
        o('Construct PIPE ArrowPipe', function () {
            return new Pipeline($1, $3);
        }),
        o('ArrowPipeline PIPE ArrowPipe', function () {
            return new Pipeline($1, $3);
        })
    ],
    Invocation: [
