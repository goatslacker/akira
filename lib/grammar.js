(function() {
  ...
  parser = new Parser((function() {
    ...
    bnf = {
      ...
      Expression: [o('Modules'), o('Value'), o('If'), o('Assignment'), o('ARGUMENTS'), o('Invocation'), o('Pipeline'), o('Declaration'), o('PatternMatching')],
      Value: [o('Literal'), o('Lists'), o('Tuples'), o('ExplicitInvocation'), o('Operation')],
      ...
      Pattern: [
        o('Literal LAMBDA Value TERMINATOR', function() {
          return [$1, new Call(new Declaration(null, null, $3), null)];
        })
      ],
      Patterns: [
        o('Pattern', function() {
      ...
      PatternMatching: [
        o('MATCH Identifier TERMINATOR Patterns', function() {
          return new Declaration($2, new Arguments('a'), new Pattern($4));
        })
      ],
      ...
      Tuples: [
        o('{ TupleItems }', function() {
          return new Tuple($2);
        }), o('{ TERMINATOR TupleItems TERMINATOR }', function() {
          return new Tuple($3);
        })
      ],
      ...
      If: [
        o('IF Value OptTerminator THEN Body OptTerminator ELSE Body', function() {
          return new If($2, $5, $8);
        })
      ],
      Operation: [
