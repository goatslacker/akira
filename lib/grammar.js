(function() {
  ...
  parser = new Parser((function() {
    ...
    bnf = {
      ...
      Value: [o('Literal'), o('Lists'), o('Tuples'), o('ExplicitInvocation'), o('Operation'), o('Access')],
      Values: [o('Value'), o('Invocation')],
      Literal: [
        o('Identifier'), o('AlphaNumeric'), o('BOOL', function() {
          return new Literal(Bool($1));
        }), o('REGEXP', function() {
      ...
      Invocation: [
        o('Identifier : Arguments', function() {
          return new Call($1, $3);
        }), o('Identifier . Identifier : Arguments', function() {
          return new Call(new Access($1, $3), $5);
        })
      ],
      ExplicitInvocation: [
        o('Identifier : Arguments ;', function() {
