(function () {
var merge = function merge(obj1, obj) {
    var base = Object.create(obj1);
    Object.keys(obj).forEach(function (key) {
        base[key] = obj[key];
    });
    return base;
};
var jison, unwrap, getMatch, addYY, o, bnf, tokens, operators, Parser, grammar, parser;
jison = require('jison');
...
this.parser = parser = merge(new Parser(grammar), require('./grammar-lex'));
